//======================================================================================
//Filename : PAZ_Distance_Measurement_using_Ultrasonic_Sensor_with_LCD_Display_I2C.ino
//Author : Al Francis B. Paz
//Email : afpaz@gbox.adnu.edu.ph
//Exercise Number:2
//Description :An arduino code that is also attached with an On/Off Switch to measure inches and centimeter to be display in LCD Display I2C
